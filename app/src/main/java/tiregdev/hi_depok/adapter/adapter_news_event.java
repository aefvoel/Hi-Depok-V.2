...
public class adapter_news_event extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<itemObject_news_event> modelList;

    private OnItemClickListener mItemClickListener;


    public adapter_news_event(Context context, ArrayList<itemObject_news_event> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<itemObject_news_event> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final itemObject_news_event model = getItem(position);
    ...
    private itemObject_news_event getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, itemObject_news_event model);
    }
