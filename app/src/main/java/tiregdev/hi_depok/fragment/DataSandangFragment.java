...
public class DataSandangFragment extends Fragment {

    ViewPager pager;
    View v;

    public static DataSandangFragment newInstance(String title) {
        DataSandangFragment fragment = new DataSandangFragment();
