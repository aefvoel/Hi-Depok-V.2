...
public class wisata_ibadah extends Fragment {

    View v;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_wisata_ibadah,container, false);
        setupAdapter();
        return v;
    }
    ...
    private List<itemObject_searchData> getAllItemList(){
        ...
        allItems.add(new itemObject_searchData(getResources().getString(R.string.tempat1),getResources().getString(R.string.alamat),
